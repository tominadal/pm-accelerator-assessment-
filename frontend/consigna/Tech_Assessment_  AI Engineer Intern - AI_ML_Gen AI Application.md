...
* **Full Stack Engineers** \= If you have the ability, we highly encourage completing both Tech Assessment **\#1 and \#2**.  *(This candidate will have the highest priority) (Do not use Python or Java frameworks for frontend assignment)*


The ideal candidate will combine their technical skills to guide the user through their input, validate their input and then store their input and retrieved API data into a database. 

Please let us know which assessment has been completed. 
...
Technology Stack \= Any **Javascript *(****ReactiveJS, NextJS, Angular, Vue.js,SolidJS)* frameworks for this front-end portion. *(Do not use Python or Java frameworks for frontend assignment). Also focus on web first approach (not mobile)*
...
# What We Need From You:  See [this section](#what-we-need-from-you-\(for-both-tech-assessment-#1-&-#2\)) below which is the same for Tech Assessment 1 & 2\. 
...
* Let users enter a location *(any of the following:  Zip Code/Postal Code, GPS Coordinates, Landmarks, Town, City, etc..) * and get the current weather.  You have autonomy to determine how to handle how the user should enter their location   
* Shows the weather clearly, with any details you think are useful.   
* Show database skills based on the **2.1 CRUD** requirements *(below)*  
* Show an example of exporting data to any format as described in **2.3 Export Data** *(below)*
...
# What We Need From You *(for both Tech Assessment \#1 & \#2)*  {#what-we-need-from-you-(for-both-tech-assessment-#1-&-#2)}

* **When**: Please send us your project AS SOON AS POSSIBLE by submitting this [Google form](https://forms.gle/XfM3Xrzpo9sbHr4g8)  no later than 7 days after receiving the assessment. If for special scenarios, you need more time to complete it, let us know. (If Dual Role applicant, then have 10 days to complete)
